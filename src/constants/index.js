...
export const skillText = [
    {
        title: '창의적인 아이디어를 현실로',
        desc: '프론트엔드 개발자로서의 길을 걷고자 하는 제 꿈은 단순히 코드를 작성하는 것을 넘어, 사용자에게 감동을 주는 경험을 만드는 것입니다. 최신 기술과 트렌드를 습득하며 끊임없이 성장하고자 합니다. 사용자 인터페이스를 통해 사람들과 소통하고, 그들이 필요로 하는 것을 직관적이고 아름답게 제공하고 싶습니다. 도전을 두려워하지 않고, 언제나 새로운 해결책을 찾기 위해 노력할 것입니다. 이 여정에서 만나는 모든 기회와 어려움이 저를 더욱 단단하게 만들 것입니다.'
    },
    {
        title: '혁신을 통해 세상을 바꾸다',
        desc: '저는 혁신적인 아이디어를 통해 세상을 변화시키는 것을 목표로 합니다. 더 나은 사용자 경험을 제공하기 위해 끊임없이 연구하고, 배우고, 발전해 나가고 있습니다. 모든 픽셀 하나하나에 정성을 담아, 사용자가 웹을 통해 더 나은 세상을 경험할 수 있도록 노력합니다. 협업을 통해 더 나은 솔루션을 찾아내고, 다양한 관점을 수용하여 창의적인 해결책을 제시하는 것을 중요시합니다. 이러한 과정 속에서 성장하는 자신을 기대합니다.'
    },
    {
        title: '비전을 가지고 미래를 설계하다',
        desc: '제 비전은 웹 기술을 통해 사람들의 삶을 더 풍요롭게 만드는 것입니다. 사용자 중심의 디자인과 접근성을 고려한 코딩으로, 모든 이가 쉽게 접근하고 사용할 수 있는 웹을 만들고자 합니다. 끊임없는 학습과 자기계발을 통해 최신 기술을 습득하고, 이를 바탕으로 혁신적인 프로젝트를 구현해 나갈 것입니다. 협업과 소통을 통해 더 큰 목표를 이루며, 더 나은 미래를 설계하는데 기여하고 싶습니다. 이러한 비전을 실현하기 위해 오늘도 한 걸음 더 나아갑니다.'
    }
]
...
export const contactText = [
    ...
    {
        link: 'mailto:rhthrck12@gmail.com',
        title: 'mail : rhthrck12@gmail.com'
    }
]
